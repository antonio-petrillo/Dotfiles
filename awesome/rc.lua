...
local keyboard_widget = require("widgets.keyboard_layout")
...
local kb_widget = keyboard_widget()
...
globalkeys = gears.table.join(
	...
	awful.key({super,            }, "i",
	   ...
	   {description = "toggle keyboard layout us <=> us-intl", group="session"}
	),
...
clientkeys = gears.table.join(
    ...
    awful.key({ super, "Shift" }, "f",  awful.client.floating.toggle                     ,
